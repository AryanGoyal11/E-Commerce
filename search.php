...
header('location:login.php');
  if(isset($_GET['search'])){
    ...
    $getProduct = "SELECT * from products where title LIKE '%$user_keyword%'";
}else {
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
  ...
  <div class="container mt-4">
    ...
    <?php
            echo'
        <h1 class="text-center">'.$user_keyword.'</h1>';
        ?>
        <hr>
        <div class="row">
        <?php
        ...
        echo'
            <div class="col-md-4 product-grid">
                ...
                <a href="index.php?PID='.$p->ID.'" class="btn btn-primary btn-block buy">BUY NOW</a>
            </div>
            ';
        }   }
            ?>
